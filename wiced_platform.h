...
#define WICED_GPIO_PIN_LED1                         WICED_P11
#define WICED_GPIO_LED_SETTINGS                     (GPIO_OUTPUT_ENABLE | GPIO_PULL_UP)
#define WICED_GPIO_LED_ON_VAL                       0

#define WICED_PUART_TXD                           WICED_P00             /* ARM GPIO pin for PUART TXD         */
#define WICED_PUART_RXD                           WICED_P33             /* ARM GPIO pin for PUART RXD         */
